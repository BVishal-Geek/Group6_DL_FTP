...
# Construct the relative path to the models folder
model_path_vgg = os.path.join(base_dir,"..", "models", "finetuned_vgg16.keras")
model_path_Inception = os.path.join(base_dir,"..", "models", "best_model.keras")
...
def implementation_page():
    ...
    if selected_model != "Select a Model":
        ...
        if uploaded_file is not None:
            ...
            st.success(f"Video saved successfully: {temp_video_path}")
            ...
            if selected_model == "InceptionV3":
                ...
                inception_model_path = model_path_Inception
                try:
                ...
                vgg_model_path = model_path_vgg
                try:
                    model_vgg16 = load_model(vgg_model_path, custom_objects={'f1_macro': f1_macro})
