...
#%%
def calculate_binary_classification_metrics(y_actual, y_pred):
    """
    Calculate precision, recall, F1-score, and accuracy for binary classification.

    Args:
        y_actual: Ground truth labels (array-like).
        y_pred: Predicted labels (array-like).

    Returns:
        A dictionary with precision, recall, F1-score, and accuracy.
    """
    cm = tf.math.confusion_matrix(y_actual, y_pred, num_classes=2)
    cm = cm.numpy()
...
metrics = calculate_binary_classification_metrics(actual.numpy(), predicted.numpy())
